...
return [
    ...
    */
    ...
    'attributes' => [
        'name' => "Adı",
        'baby_age_limit' => "Bebek yaşı sınırı",
        'child_age_limit' => "Çocuk yaşı sınırı",
        'young_age_limit' => "Genç yaşı sınırı",
        'latitude' => "Enlem",
        'longitude' => "Boylam",
        'max_adult_count' => "Maksimum yetişkin sayısı",
        'max_bed_count' => "Maksimum yatak sayısı",
        'slug' => 'URL Yapılandırması',
        'person_name' => 'Kişi Adı',
        'person_surname' => 'Kişi SoyAdı',
        'person_email' => 'Kişi Email',
        'person_mobile' => 'Kişi Telefon',
    ],
