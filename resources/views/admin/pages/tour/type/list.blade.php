    ...
    <div class="">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <a href="{{ route('tour_type.create')}}" class="btn btn-success btn-md">
                            <i class="fa fa-plus"></i> Tur Türü Ekle
                        </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form id="delete-form-{{$row->id}}" method="post"
                                              action="{{ route('tour_type.destroy',$row->id) }}">
                                        <a href="{{ route('tour_type.edit',$row->id) }}"
