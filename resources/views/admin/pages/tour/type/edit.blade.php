            ...
            <div class="col-md-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <a href="{{ route('tour_type.create') }}" class="btn btn-success pull-right">
                            <i class="fa fa-undo"></i> Tur Türü Ekle
                        </a>
                            ...
                            <div id="myTabContent" class="tab-content">
                                <div role="tabpanel" class="tab-pane fade active in" id="tab_content1"
                                    ...
                                    <form class="form-horizontal" method="POST"
                                          action="{{ route('tour_type.update',$type->id)}}">
                                        @csrf
                                        @method("PUT")
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $type->name ?? '' }}" type="text" id="name"
                                                           name="name"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <img src="{{ asset('tours/types/images/' . $type->file->name ?? '') }}"
                                                             width="200">
                                                    </div>
                                                    <br>
