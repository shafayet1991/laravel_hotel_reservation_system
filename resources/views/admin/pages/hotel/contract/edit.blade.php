                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label class="control-label" for="adult_rate">Yetişkin<span
                                                    class="required">*</span>
                                        </label>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label class="control-label" for="first_child_rate">1.Çocuk<span
                                                    class="required">*</span>
                                        </label>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label class="control-label" for="second_child_rate">2.Çocuk<span
                                                    class="required">*</span>
                                        </label>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label class="control-label" for="third_child_rate">3.Çocuk<span
                                                    class="required">*</span>
                                        </label>
