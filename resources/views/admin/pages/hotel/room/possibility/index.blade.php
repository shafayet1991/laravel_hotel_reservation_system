            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <a href="{{ route('room_possibility.create')}}" class="pull-right btn btn-success btn-xs">
                    ...
                    <div class="x_content">
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <tbody>
                            @forelse($room_possibilities as $row)
                                <tr>
                                    <td>{{$row->name}}</td>
                                    <td>
                                        <form id="delete-form-{{$row->id}}" method="post"
                                              action="{{ route('room_possibility.destroy',$row->id) }}">
                                        <a href="{{ route('room_possibility.edit',$row->id) }}"
