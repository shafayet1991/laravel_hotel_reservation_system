    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Blog Etiketi Düzenle</h2>
                        <a href="{{ route('blog_tag.index') }}" class="btn btn-info btn-md pull-right">
                    ...
                    <div class="x_content">
                        ...
                        <form action="{{ route('blog_tag.update',$tag->id) }}"
                              enctype="multipart/form-data" method="post">
                            @csrf
                            @method('PUT')
                            <input type="hidden" value="{{ $tag->id ?? 0 }}" name="blog_tag_id">
                            <div class="row">
                                <div class="tab-pane active" id="turkish">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="slugconvert" class="form-control"
                                               value="{{ $tag->name ?? old('name') }}" name="name">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $tag->slug ?? old('slug') }}" id="slug"
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" id="page_title" name="page_title"
                                           class="form-control"
                                           value="{{ $tag->seo->page_title ?? old('page_title') }}">
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" id="seo_title" name="seo_title"
                                           class="form-control"
                                           value="{{ $tag->seo->seo_title ?? old('seo_title') }}">
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" id="seo_keyword" name="seo_keyword"
                                           class="form-control"
                                           value="{{ $tag->seo->seo_keyword ??  old('seo_keyword') }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="2"
                                              name="seo_description">{{ $tag->seo->seo_description ?? old('seo_description') }}</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
