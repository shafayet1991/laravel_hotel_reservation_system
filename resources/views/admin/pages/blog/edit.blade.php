                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <a href="{{ route('blog.index') }}" class="btn btn-info btn-md pull-right">
                            <i class="fa fa-undo"></i> Return to Blog List
                        </a>
                            ...
                            <form action="{{ route('blog.update',$blog->id ?? 0) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-5">
                                        <label class="control-label">Blog Categories<span
                                                    class="required">*</span>
                                        </label>
                                    ...
                                    <div class="form-group col-md-5">
                                        <label class="control-label">Blog Labels<span
                                                    class="required">*</span>
                                        </label>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label class="control-label" for="short_description">
                                            Short Description<span class="required"> (It is only shown on the blog listing page. Try to summarize in a few sentences.)</span>
                                        </label>
