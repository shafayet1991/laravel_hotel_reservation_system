    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <a href="{{ route('blog_category.create') }}" class="btn btn-success btn-md pull-right">
                    <i class="fa fa-plus"></i> Blog Kategorisi Ekle
                </a>
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Blog Kategoriler
                            <small>({{ count($categories ?? 0) }})</small>
                        </h2>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form id="delete-form-{{$row->id}}" method="post"
                                              action="{{ route('blog_category.destroy',$row->id) }}">
                                            <a href="{{ route('blog_category.edit',$row->id) }}"
