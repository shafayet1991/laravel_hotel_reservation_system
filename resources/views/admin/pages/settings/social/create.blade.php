            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="col-md-12">
                            <form action="{{ route('social_media_setting.store') }}" method="post">
                                @csrf
                                ...
                                <div class="form-group col-md-3">
                                    <label class="control-label" for="name">URL Bilgisi<span
                                            class="required">*</span>
                                    </label>
                                    <input type="text" class="form-control"
                                           value="{{ old('name') }}" name="url">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label" for="name">İkonu<span
                                            class="required"> (https://fontawesome.com/ Adresinden daha fazla ikon bulabilirsiniz. Örn fa fa-facebook)</span>
                                    </label>
                                    <input type="text" class="form-control"
                                           value="{{ old('name') }}" name="icon">
                                </div>
                                <br>
