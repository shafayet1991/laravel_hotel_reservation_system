<div class="container second-special-container my-5 py-3 px-5">
    <div class="row">
        ...
        @foreach($thermal_hotels as $indexKey => $hotel)
    ...
    <div class="row">
        <div class="col-md-12 col-12 mt-4 text-center">
            <a href="{{route('search',['type' => 'thermal_hotels','search_label' => 'Termal Oteller', 'adult_count' => 1 ,'child_count' => 1, 'child_ages' => [0,0,0,0], 'start_date' => \Carbon\Carbon::now()->format('d.m.Y'), 'end_date' => \Carbon\Carbon::now()->addDay(1)->format('d.m.Y')])}}"
