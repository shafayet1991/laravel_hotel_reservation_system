<div class="container second-special-container my-5 py-3 px-5">
    <div class="row">
        <div class="col-md-12">
            <h3><label class="text-left font-weight-bold mt-2">
                    Şehir Otelleri
                </label></h3>
        </div>
        @foreach($city_hotels as $indexKey => $hotel)
            ...
            <div class="col-md-4 mt-4">
                <div class="card first-special-card">
                    ...
                    <div class="card-body pb-1">
                        ...
                        <br><label class="card-text p-0 mt-0" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content=""><i class="fa fa-check second-text-color"></i>
    ...
    <div class="row">
        <div class="col-md-12 col-12 mt-4 text-center">
            <a href="{{route('search',['type' => 'city_hotels','search_label' => 'Şehir Otelleri', 'adult_count' => 1 ,'child_count' => 1, 'child_ages' => [0,0,0,0], 'start_date' => \Carbon\Carbon::now()->format('d.m.Y'), 'end_date' => \Carbon\Carbon::now()->addDay(1)->format('d.m.Y')])}}"
